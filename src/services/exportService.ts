  ...
  const html = `
    ...
    <body>
      <div class="header">
        ...
        <div class="period">JACHETECI CRM Application Logiciel - Période: ${content.period}</div>
      </div>
      ...
      <div class="footer">
        ...
        Logiciel de Gestion JACHETECI CRM - Identifiant Audit: ${Math.random().toString(36).substring(2, 10).toUpperCase()}
      </div>
    </body>
    </html>
  `;
